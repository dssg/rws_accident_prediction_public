...
--- Tables
--- 	onehour_hecto_v2: This table aggregates features across lanes for each hectopunt.  
---			The features in this table are used to generate features that are across segments. 

--- 	onehour_ten_km_v2: Uses the onehour_hecto_v2 table to aggregate features across road segments.
...
--- 	onehour_five_km_v1: aggregates over 5 km segments using segmentation.five_km table

--- 	onehour_three_km_v1: aggregates over 3 km segments using segmentation.three_km table

--- 	onehour_two_km_v1: aggregates over 2 km segments using segmentation.two_km table

--- 	onehour_one_km_v1: aggregates over 1 km segments using segmentation.one_km table
...
-------------------- 5 km aggregation --------------------
drop TABLE IF exists features_speedflow_agg.onehour_five_km_v1;
create table features_speedflow_agg.onehour_five_km_v1(
	end_datetime timestamp without time zone,
	hectokey_merged varchar,
	speed_diffxlanes_maxhecto_avgseg decimal,
	speed_diffxlanes_maxhecto_maxseg decimal,
...
insert into features_speedflow_agg.onehour_five_km_v1
select 
	sf.end_datetime,
	seg.hectokey_merged,
	avg(max_speed_diff_across_lanes) AS speed_diffxlanes_maxhecto_avgseg,
...
-------------------- 3 km aggregation --------------------
drop TABLE IF exists features_speedflow_agg.onehour_ten_km_v1;
create table features_speedflow_agg.onehour_three_km_v1(
	end_datetime timestamp without time zone,
	hectokey_merged varchar,
	speed_diffxlanes_maxhecto_avgseg decimal,
	speed_diffxlanes_maxhecto_maxseg decimal,
...
insert into features_speedflow_agg.onehour_three_km_v1
select 
	sf.end_datetime,
	seg.hectokey_merged,
	avg(max_speed_diff_across_lanes) AS speed_diffxlanes_maxhecto_avgseg,
...
-------------------- 2 km aggregation --------------------
drop TABLE IF exists features_speedflow_agg.onehour_two_km_v1;
create table features_speedflow_agg.onehour_two_km_v1(
	end_datetime timestamp without time zone,
	hectokey_merged varchar,
	speed_diffxlanes_maxhecto_avgseg decimal,
	speed_diffxlanes_maxhecto_maxseg decimal,
...
insert into features_speedflow_agg.onehour_two_km_v1
select 
	sf.end_datetime,
	seg.hectokey_merged,
	avg(max_speed_diff_across_lanes) AS speed_diffxlanes_maxhecto_avgseg,
...
-------------------- 1 km aggregation --------------------
drop TABLE IF exists features_speedflow_agg.onehour_one_km_v1;
create table features_speedflow_agg.onehour_one_km_v1(
	end_datetime timestamp without time zone,
	hectokey_merged varchar,
	speed_diffxlanes_maxhecto_avgseg decimal,
	speed_diffxlanes_maxhecto_maxseg decimal,
...
insert into features_speedflow_agg.onehour_one_km_v1
select 
	sf.end_datetime,
	seg.hectokey_merged,
	avg(max_speed_diff_across_lanes) AS speed_diffxlanes_maxhecto_avgseg,
